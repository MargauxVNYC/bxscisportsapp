                ...
                builder: (context, snapshot) {
                  ...
                  return TextFormField(
                    controller: _model.yourNameController ??=
                      ...
                      text: yourNameUsersRecord!.displayName,
                    ),
            ...
            Padding(
              ...
              child: StreamBuilder<List<UsersRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<UsersRecord> osisUsersRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final osisUsersRecord = osisUsersRecordList.isNotEmpty
                      ? osisUsersRecordList.first
                      : null;
                  return TextFormField(
                    controller: _model.osisController ??= TextEditingController(
                      text: osisUsersRecord!.osis.toString(),
                    ),
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator:
                        _model.osisControllerValidator.asValidator(context),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: StreamBuilder<List<UsersRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final passwordUsersRecord = passwordUsersRecordList.isNotEmpty
                      ? passwordUsersRecordList.first
                      : null;
                  return TextFormField(
                    controller: _model.passwordController ??=
                        TextEditingController(
                      text: passwordUsersRecord!.userPassword,
                    ),
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
            ...
            Padding(
              ...
              child: StreamBuilder<List<UsersRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<UsersRecord> gradYearUsersRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final gradYearUsersRecord = gradYearUsersRecordList.isNotEmpty
                      ? gradYearUsersRecordList.first
                      : null;
                  return TextFormField(
                    controller: _model.gradYearController ??=
                        TextEditingController(
                      text: gradYearUsersRecord!.gradyear.toString(),
                    ),
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator:
                        _model.gradYearControllerValidator.asValidator(context),
                  );
                },
              ),
            ),
